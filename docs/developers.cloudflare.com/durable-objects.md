...
<Description>
	Create AI agents, collaborative applications, real-time interactions like
	chat, and more without needing to coordinate state, have separate storage, or
...
[SQLite storage](/durable-objects/best-practices/access-durable-objects-storage/) and corresponding [Storage API](/durable-objects/api/sqlite-storage-api/) methods like `sql.exec` have moved from beta to general availability. New Durable Object classes should use wrangler configuration for [SQLite storage](/durable-objects/reference/durable-objects-migrations/#create-migration).
:::
...
<Feature header="Storage API" href="/durable-objects/api/sqlite-storage-api/">

Learn how Durable Objects provide transactional, strongly consistent, and serializable storage.

</Feature>

<Feature header="WebSocket Hibernation" href="/durable-objects/best-practices/websockets/#durable-objects-hibernation-websocket-api">
...
<LinkTitleCard
	title="Limits"
	href="/durable-objects/platform/limits/"
	icon="document"
>
...
<LinkTitleCard
	title="Pricing"
	href="/durable-objects/platform/pricing/"
	icon="pen"
>
