---
Source: https://www.pulumi.com/docs/iac/cli/commands/pulumi_stack/
...
title: "pulumi stack | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_stack/
meta_desc: "Manage stacks and view stack state. Create, select, and manage your deployment environments."
---
...
```
  -h, --help            help for stack
      --output string   The output format: default (human-readable) or json (default "default")
...
* [pulumi stack get](/docs/iac/cli/commands/pulumi_stack_get/)	 - [EXPERIMENTAL] Retrieve detailed information about a stack
...
* [pulumi stack new](/docs/iac/cli/commands/pulumi_stack_new/)	 - Create an empty stack with the given name, ready for updates
