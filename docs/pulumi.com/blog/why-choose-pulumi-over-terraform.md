---
Source: https://www.pulumi.com/blog/why-choose-pulumi-over-terraform/
...
![Why Choose Pulumi Over Terraform?](/blog/why-choose-pulumi-over-terraform/feature_hu_64fc8e93f8d24bad.642bf9915e7cb2cb5f2fa96286cea6af0af78986c07b4ff220a04813e64bf4cc.webp)

# Why Choose Pulumi Over Terraform?

 [![Pablo Seibelt](/images/team/pablo-seibelt.jpg)](/blog/author/pablo-seibelt/)[Pablo Seibelt](/blog/author/pablo-seibelt/)
...
## Use programming languages and familiar tools[](#use-programming-languages-and-familiar-tools)
...
## Refactor infrastructure without surprise replacement[](#refactor-infrastructure-without-surprise-replacement)
...
## Handle secrets with encrypted configuration and secret outputs[](#handle-secrets-with-encrypted-configuration-and-secret-outputs)
...
## Add safer lifecycle controls for destructive changes[](#add-safer-lifecycle-controls-for-destructive-changes)
...
## Model environments with stacks[](#model-environments-with-stacks)
...
## Test infrastructure with normal language tooling[](#test-infrastructure-with-normal-language-tooling)
...
## Wire providers explicitly[](#wire-providers-explicitly)
...
## Import and migrate incrementally[](#import-and-migrate-incrementally)
...
## What Pulumi does not magically fix[](#what-pulumi-does-not-magically-fix)
...
## OpenTofu compatibility caveat[](#opentofu-compatibility-caveat)
...
## Get started with Pulumi[](#get-started-with-pulumi)
...
-   [terraform](/blog/tag/terraform/)
-   [pulumi](/blog/tag/pulumi/)
