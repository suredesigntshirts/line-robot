---
Source: https://www.pulumi.com/blog/self-host-gemma4-llama-cpp-k8s-tailscale-pulumi/
...
![Use Your Mac for AI Agents: Self-Host Gemma 4 12 B with Pulumi and Tailscale](/blog/self-host-gemma4-llama-cpp-k8s-tailscale-pulumi/feature_hu_5ec2da900bb79ab.58d1d2d877bb6673136344ccd36f7c364554f3720c43183640a245c7fe67bf20.webp)

# Use Your Mac for AI Agents: Self-Host Gemma 4 12 B with Pulumi and Tailscale

 [![Pablo Seibelt](/images/team/pablo-seibelt.jpg)](/blog/author/pablo-seibelt/)[Pablo Seibelt](/blog/author/pablo-seibelt/)

Posted on Jun 4th, 2026
...
## Run Gemma 4 with host-native llama.cpp[](#run-gemma-4-with-host-native-llamacpp)
...
![Open WebUI using local Gemma 4 12 B to describe an uploaded Pulumi logo](/blog/self-host-gemma4-llama-cpp-k8s-tailscale-pulumi/describe_image.png)

### Verify the LLM API[](#verify-the-llm-api)
...
### Keep llama.cpp running after reboot[](#keep-llamacpp-running-after-reboot)
...
## Deploy Open WebUI with Pulumi and k3d[](#deploy-open-webui-with-pulumi-and-k3d)
...
## Access Open WebUI through Tailscale[](#access-open-webui-through-tailscale)
...
## Use the model with Pi[](#use-the-model-with-pi)
...
![Pi connected to local Gemma 4 through llama.cpp](/blog/self-host-gemma4-llama-cpp-k8s-tailscale-pulumi/pi.png)

## Advanced: Linux GPU in-cluster serving[](#advanced-linux-gpu-in-cluster-serving)
...
-   [ai](/blog/tag/ai/)
-   [kubernetes](/blog/tag/kubernetes/)
-   [tailscale](/blog/tag/tailscale/)
