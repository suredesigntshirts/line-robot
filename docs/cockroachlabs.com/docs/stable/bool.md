---
Source: https://www.cockroachlabs.com/docs/stable/bool
...
The `BOOL` [data type](/docs/v26.2/data-types) stores a Boolean value of `false` or `true`.
...
There are two predefined [named constants](/docs/v26.2/sql-constants#named-constants) for `BOOL`: `TRUE` and `FALSE` (the names are case-insensitive).
...
`BOOL` values can be [cast](/docs/v26.2/data-types#data-type-conversions-and-casts) to any of the following data types:
