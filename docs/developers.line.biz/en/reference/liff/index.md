...
- `liff.referrer`: Indicates the URL before a LIFF-to-LIFF transition. For more information, see [Get URL from before LIFF-to-LIFF transition](https://developers.line.biz/en/docs/liff/opening-liff-app/#using-liff-referrer) in the LIFF documentation.
